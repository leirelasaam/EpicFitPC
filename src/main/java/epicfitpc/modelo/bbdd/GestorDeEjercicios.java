...
public class GestorDeEjercicios {
	...
	private static final String COLLECTION = "Ejercicios";

	public GestorDeEjercicios(Firestore db) {
		this.db = db;
	}
	
	public ArrayList<Ejercicio> obtenerEjerciciosPorWorkout(Workout workout) throws InterruptedException, ExecutionException {
		ArrayList<Ejercicio> workouts = null;
