...
public class Rutas {
	...
	public static final String IMG_PIERNAS = "src/main/resources/img/workout/piernas.png";
	public static final String IMG_ABS = "src/main/resources/img/workout/abs.png";
