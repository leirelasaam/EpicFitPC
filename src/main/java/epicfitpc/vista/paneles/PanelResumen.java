...
public class PanelResumen extends JPanel {
	...
	private void initialize() {
		...
		JLabel labelTiempoTotal = new JLabel("Tiempo total: " + historico.getTiempo());
		...
		JLabel labelPorcentajeEjercicios = new JLabel("Porcentaje completado: 100%"); //historico.getPorcentaje()
		...
		panelInferior.setLayout(new BoxLayout(panelInferior, BoxLayout.Y_AXIS)); // Ordenamos verticalmente
		panelInferior.setBackground(Estilos.DARK_BACKGROUND); // Asegúrate de que tenga un fondo
	...
	private void cerrarPanel() {
		/*
		 * this.setVisible(false); this.getParent().getParent().remove(this);
